...
export default (props: { val: number|string, label?: string, unit?: string, fontSize?: number, prec?:number}) => {
    ...
    return (
        <div className="meter">
            <span style={{fontSize: props.fontSize+'px'}}>{val.toFixed(props.prec)} {unit}</span>
